...
/** A slide's id + title, mirrored from the doc for the Pages panel. */
...
export interface PageBuilderState {
   ...
   * ProseMirror context, so `PagesSync` (inside the editor) pushes the
   * page list + active id here and stashes the live `view` for dispatching
   * (switch / reorder / add / duplicate / delete). Same bridge pattern as
   * `isDragging` / `ShuffleDragSync`.
   */
  pages: PageMeta[];
